...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vanditshah99/lnd/lnwallet)
...
```shell
$  go get -u github.com/vanditshah99/lnd/lnwallet
```
