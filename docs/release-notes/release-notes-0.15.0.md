...
* A new command `lncli leaseoutput` was [added](https://github.com/vanditshah99/lnd/pull/5964).
...
* Add an [always on](https://github.com/vanditshah99/lnd/pull/6232) mode to
