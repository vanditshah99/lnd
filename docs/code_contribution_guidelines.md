...
initial [Lightning Network Specifications](https://github.com/vanditshah99/lightning-rfc).
...
- Changes to publicly exported packages such as
  [brontide](https://github.com/vanditshah99/lnd/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/vanditshah99/lnd/blob/master/lntest/harness.go)
  contained within `lnd`. For example integration tests, see
  [`lnd_test.go`](https://github.com/vanditshah99/lnd/blob/master/itest/lnd_test.go).
...
[perusing the make file documentation](https://github.com/vanditshah99/lnd/blob/master/docs/MAKEFILE.md).
...
```shell
$  go mod edit -replace=github.com/vanditshah99/lightning-onion@v0.0.0-20180605012408-ac4d9da8f1d6=github.com/roasbeef/lightning-onion@2e5ae87696046298365ab43bcd1cf3a7a1d69695
```
...
PR](https://github.com/vanditshah99/lnd/tree/master/docs/release-notes).
...
Rejoice as you will now be listed as a [contributor](https://github.com/vanditshah99/lnd/graphs/contributors)!
...
See [template](https://github.com/vanditshah99/lnd/blob/master/.github/pull_request_template.md).

## Licensing of Contributions
****
All contributions must be licensed with the
[MIT license](https://github.com/vanditshah99/lnd/blob/master/LICENSE).  This is
