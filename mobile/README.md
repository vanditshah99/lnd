...
Go](https://github.com/vanditshah99/lnd/blob/master/docs/INSTALL.md#building-a-development-version-from-source).
...
```shell
git clone https://github.com/vanditshah99/lnd.git $GOPATH/src/github.com/vanditshah99/lnd
```
