...
[In this PR](https://github.com/vanditshah99/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/vanditshah99/lnd/aezeed
...
PASS
ok      github.com/vanditshah99/lnd/aezeed  4.168s
```
