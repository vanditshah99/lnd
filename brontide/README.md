...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vanditshah99/lnd/brontide)
...
detail in [BOLT #8 of the Lightning Network specifications](https://github.com/vanditshah99/lightning-rfc/blob/master/08-transport.md).
...
```shell
$  go get -u github.com/vanditshah99/lnd/brontide
```
